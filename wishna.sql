...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 19 jan. 2021 à 12:52
...
(1, 'bitSilvioCoin', 'notStonks'),
(2, 'cryptoNico', 'minagePro0x004587'),
(3, 'Xx_Arthur_xX', 'pokemonWorld57');
...
INSERT INTO `liste` (`no`, `user_id`, `titre`, `description`, `expiration`, `token`, `tokenAdmin`, `etrePublique`) VALUES
(1, 1, 'Pour fêter le bac !', 'Pour un week-end à Nancy qui nous fera oublier les épreuves. ', '2018-06-27', 'nosecure1', NULL, 0),
(2, 2, 'Liste de mariage d\'Alice et Bob', 'Nous souhaitons passer un week-end royal à Nancy pour notre lune de miel :)', '2018-06-30', 'nosecure2', NULL, 0),
(3, 3, 'C\'est l\'anniversaire de Charlie', 'Pour lui préparer une fête dont il se souviendra :)', '2017-12-12', 'nosecure3', NULL, 0);
